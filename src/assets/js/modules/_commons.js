...
import detect from './_detect';
import WebFontLoader from './_webfont-loader';
import inlineSVG from './_inline-svg';
import viewPort from './_viewport';
import smoothScroll from './_jquery-smooth-scroll';
import matchHeight from './_jquery-match-height';
import dotdotdot from './_jquery-dotdotdot';
import touchHover from './_touch-hover';
import hamburgerMenu from './_hamburger-menu';
