...
import detect from './modules/_detect';
import WebFontLoader from './modules/_webfont-loader';
import inlineSVG from './modules/_inline-svg';
import viewPort from './modules/_viewport';
import smoothScroll from './modules/_jquery-smooth-scroll';
import matchHeight from './modules/_jquery-match-height';
import dotdotdot from './modules/_jquery-dotdotdot';
import touchHover from './modules/_touch-hover';
import hamburgerMenu from './modules/_hamburger-menu';
